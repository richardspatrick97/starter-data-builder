...
public class TinkarStarterData {
    ...
    private static void configureConcepts(StarterData starterData){
        starterData.concept(TinkarTerm.ACCEPTABLE)
                .fullyQualifiedName("Acceptable (IKM)", TinkarTerm.PREFERRED)
                .synonym("Acceptable", TinkarTerm.PREFERRED)
                .definition("Description as written is acceptable in the language dialect defined", TinkarTerm.PREFERRED)
                ...
                .statedDefinition(TinkarTerm.DESCRIPTION_ACCEPTABILITY)
                .build();
        ...
        starterData.concept(TinkarTerm.DESCRIPTION_ACCEPTABILITY)
                ...
                .inferredNavigation(List.of(TinkarTerm.ACCEPTABLE), List.of(TinkarTerm.ROOT_VERTEX))
                .statedNavigation(null, null)
                .statedDefinition(TinkarTerm.ROOT_VERTEX)
                .build();
        ...
        starterData.concept(TinkarTerm.ROOT_VERTEX)
                .fullyQualifiedName("Integrated Knowledge Management", TinkarTerm.PREFERRED)
                .synonym("IKM", TinkarTerm.PREFERRED)
                ...
                .inferredNavigation(List.of(TinkarTerm.DESCRIPTION_ACCEPTABILITY), null)
                .statedNavigation(null, null)
                .statedDefinition(TinkarTerm.ROOT_VERTEX)
                .build();
    }
