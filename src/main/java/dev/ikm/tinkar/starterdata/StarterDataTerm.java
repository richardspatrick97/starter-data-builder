...
public class StarterDataTerm {
    ...
    public static final EntityProxy.Pattern PATH_MEMBERSHIP_PATTERN = EntityProxy.Pattern.make("Path membership", UUID.fromString("add1db57-72fe-53c8-a528-1614bda20ec6"));
